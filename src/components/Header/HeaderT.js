  ...
  return (
    <>
      <nav className='flex justify-between max-w-7xl m-auto p-2 sm:p-5 text-white shadow bg-gray-900'>
        <img
          className='object-fill h-10 w-40 mt-2 shadow-lg shadow-indigo-500/40'
        ...
        {token ? (
          <div className='flex p-2 gap-3'>
            <a
              className='mt-2 p-1 hover:bg-gray-700 rounded text-3xl'
              href='/aboutme'
            >
              <FaUserCircle />
            </a>
            <button
              ...
              className='mt-2 text-2xl hover:text-red-800'
              href=''
            >
              <FaSignOutAlt />
            </button>
            ...
            <div className='group mt-2 '>
              ...
              <div className='group-hover:block dropdown-menu absolute hidden h-auto  right-10 mt-1 bg-gray-800 p-2'>
                <a
                  ...
                  href='https://www.cryptonaukri.com/devsignup'
                >
                  Developer Signup
                </a>
                <br />
                <a
                  ...
                  href='https://www.cryptonaukri.com/companySignUp'
                >
                  Business Signup
                </a>
              </div>
      ...
      {showLinks ? (
        <div className='bg-gray-900 p-2'>
          <div className='flex flex-col text-center rounded mr-3 ml-3 bg-gray-800 text-white shadowlg shadow-gray-500/40'>
            <a
